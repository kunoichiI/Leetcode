package etc;
//Dynamic Programming naive solution // time: O(2^n) ,space : O(logn) call stack
//Examples:
...
public class LCS { 
	...
	private static int helper(String s1, String s2, int idx1, int idx2) {
		...
		if (s1.charAt(idx1 - 1) == s2.charAt(idx2 - 1)) {
			System.out.println("character in common: " + s1.charAt(idx1 - 1));
	...
	public static void main(String[] args) {
		String s1 = "ABCDGH";
		String s2 = "AEDFHR";
		System.out.println(lcs(s1, s2)); // 3 "ADH"
		
		String s3 = "AGGTAB";
		String s4 = "GXTXAYB";
		System.out.println(lcs(s3, s4)); // 4 "GTAB"
