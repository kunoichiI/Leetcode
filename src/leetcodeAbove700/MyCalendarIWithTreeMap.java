 ...
 */
public class MyCalendarIWithTreeMap {
	/* time complexity: O(logN) */
	private TreeMap<Integer, Integer> calendar;
    public MyCalendarIWithTreeMap() {
    ...
    /*
     * TreeMap insertion time complexity: O(logn)
     * floorKey is the greatest key that is less then or equal to the given key.
     * ceilingKey is the smallest key that is greater than or equal to the given key.
     */
}
