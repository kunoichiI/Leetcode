 ...
 */
public class BestTimeToBuyAndSellStockIIOptimal {
	...
	public static void main(String[] args) {
		...
		System.out.print(maxProfit(prices)); // 12
	}
}
/*
 * 画图是最直观的解题方式。计算波峰和波谷差值
 * ref：https://leetcode.com/articles/best-time-buy-and-sell-stock-ii/
 */
